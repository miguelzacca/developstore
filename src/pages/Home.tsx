    ...
    <main id="Home" >
      ...
      <section id="recommended-products">
        <div className="control-container">
          ...
          <div className="scroll-container">
            <button className="scroll-right" onClick={() => moveScroll(0, -moveScrollValue)}>
              <img src={arrowLeftImg} alt="Arrow left icon" />
            </button>
            <button className="scroll-left" onClick={() => moveScroll(0, moveScrollValue)}>
      ...
      <section id="popular-products">
        <div className="control-container">
          <h2>Popular 2024</h2>
          <div className="scroll-container">
            <button className="scroll-right" onClick={() => moveScroll(1, -moveScrollValue)}>
              <img src={arrowLeftImg} alt="Arrow left icon" />
            </button>
            <button className="scroll-left" onClick={() => moveScroll(1, moveScrollValue)}>
              <img src={arrowRightImg} alt="Arrow right icon" />
            </button>
          </div>
        </div>
      ...
      <section id="best-products">
        <div className="control-container">
          <h2>The best</h2>
          <div className="scroll-container">
            <button className="scroll-right" onClick={() => moveScroll(2, -moveScrollValue)}>
              <img src={arrowLeftImg} alt="Arrow left icon" />
            </button>
            <button className="scroll-left" onClick={() => moveScroll(2, moveScrollValue)}>
              <img src={arrowRightImg} alt="Arrow right icon" />
            </button>
          </div>
        </div>
